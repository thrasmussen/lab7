...
1. [Introduction](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#introduction)
2. [Collecting Channel Zaps](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#collecting-channel-zaps)
3. [Traffic Generator](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#traffic-generator)
4. [Building a Zap Event Processing Server](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#building-a-zap-event-processing-server)
5. [Publish/Subscribe RPC Client and Server](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#publishsubscribe-grpc-client-and-server)
6. [Lab Approval](https://github.com/uis-dat320/glabs/blob/master/lab7/README.md#lab-approval)
...
a stream of viewership statistics (the top-10 list). A subscriber client should at least
include the client address and refresh rate in the subscribe request.
...
[version 3.0.0 or higher](https://github.com/google/protobuf/releases). 
